...
export default function EditClientModal({ isOpen, client, onClose, onSave }: EditClientModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-150 w-full max-w-2xl overflow-hidden relative z-10 transform transition-all duration-300 scale-100 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4.5 border-b border-gray-100">
          <div>
            <h3 className="text-lg font-bold text-gray-900">Modifier le client : {client.id}</h3>
            <p className="text-xs text-gray-400 mt-0.5">Mettez à jour les informations du client.</p>
          </div>
          <button 
            onClick={onClose}
