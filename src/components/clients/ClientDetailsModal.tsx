...
export default function ClientDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white dark:bg-slate-950 rounded-2xl shadow-2xl border border-gray-150 dark:border-slate-800 w-full max-w-lg overflow-hidden relative z-10 transform transition-all duration-300 scale-100 flex flex-col">
        <div className="flex items-center justify-between px-6 py-4.5 border-b border-gray-100 dark:bg-slate-800 dark:border-slate-800">
          <div className="flex items-center gap-2.5">
            <span className="bg-orange-50 dark:bg-orange-500/10 text-brand-orange text-xs font-bold px-2.5 py-1 rounded-lg font-mono">
              {client.id}
            </span>
        ...
        <div className="p-6 space-y-6">
          <div className="flex items-center gap-4 bg-gray-50/50 dark:bg-slate-950 p-4 rounded-xl border border-gray-100 dark:border-slate-700/60">
            <div className="w-12 h-12 rounded-xl bg-orange-100/60 dark:bg-orange-950/40 text-brand-orange flex items-center justify-center font-bold text-lg">
              {initials}
            </div>
            <div>
              ...
              <div className="flex flex-col gap-1 mt-1 text-xs text-gray-500 dark:text-slate-400 font-mono">
                <div className="flex items-center gap-1.5">
                  <Phone className="w-3.5 h-3.5" />
                  <span>{client.phone_number}</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <span className="font-semibold text-gray-600 dark:text-slate-300">{t("clients.type")}:</span>
          ...
          <div className="space-y-3.5">
            ...
            <div className="flex items-start gap-2 border-t border-gray-50 dark:border-slate-800 pt-3">
