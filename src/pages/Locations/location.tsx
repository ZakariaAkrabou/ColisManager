...
export default function Location() {
  ...
  const handleDelete = async (id: string) => {
    ...
    if (result.isConfirmed) {
      ...
      await Swal.fire({
        title: "Supprime",
        text: "La location a ete supprimee.",
        icon: "success",
        timer: 1400,
        ...
        <div className="overflow-x-auto w-full">
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-gray-50 text-gray-600 border-b border-gray-200">
              <tr>
                <th className="px-6 py-4 font-medium">ID Location</th>
                <th className="px-6 py-4 font-medium">Pays (Country)</th>
                <th className="px-6 py-4 font-medium">Région (Region)</th>
                <th className="px-6 py-4 font-medium">Ville (City)</th>
